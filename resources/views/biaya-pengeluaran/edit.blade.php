        ...
        <form action="{{ route('biaya-konsumsi.update', $biayaKonsumsi) }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="keterangan" name="keterangan" value="{{ old('keterangan', $biayaKonsumsi->keterangan) }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brown-500" required autocomplete="off">
