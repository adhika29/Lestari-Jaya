...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="overflow-x-auto mb-6">
            <div class="flex items-center min-w-max gap-4 p-2">
                ...
                <form action="{{ route('biaya-operasional.index') }}" method="GET" class="flex items-center space-x-4 flex-shrink-0">
                ...
                <div class="flex space-x-2 flex-shrink-0">
                    <a href="{{ route('biaya-operasional.export-pdf', request()->query()) }}" class="border border-red-500 text-red-500 px-4 py-2 rounded-lg flex items-center hover:bg-red-50 whitespace-nowrap">
