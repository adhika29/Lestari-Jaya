...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white p-3 rounded-lg shadow-sm mb-4">
        <div class="flex items-center text-sm text-gray-600">
            ...
            <span class="text-brown-500 font-medium">Tambah Biaya Operasional</span>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex items-center mb-6">
            <a href="{{ route('biaya-operasional.index') }}" class="text-brown-500 hover:text-brown-700 mr-4">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                </svg>
            </a>
            <h2 class="text-xl font-semibold">Tambah Biaya Operasional</h2>
        </div>
