...
<head>
    ...
    <title>Daftar - LestariJaya</title>
    ...
    <div class="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div class="bg-white rounded-3xl shadow-lg w-full max-w-md mx-4 z-10 overflow-hidden">
            ...
            <div class="p-8">
                ...
                <h2 class="text-2xl font-bold mb-6">Buat Akun</h2>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4">
                        <div class="relative">
                            ...
                            <input type="text" id="name" name="name" placeholder="Nama Lengkap" value="{{ old('name') }}" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brown-500 focus:border-transparent" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" placeholder="Masukkan email" value="{{ old('email') }}" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brown-500 focus:border-transparent" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password" placeholder="Masukkan password" class="w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brown-500 focus:border-transparent" required>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Min. 8 karakter dengan huruf dan angka</p>
                    </div>
                    ...
                    <div class="mb-6">
                        <div class="relative">
                            ...
                            <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Konfirmasi password" class="w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brown-500 focus:border-transparent" required>
                            <button type="button" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 password-toggle">
                                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M12,4.5C7,4.5,2.73,7.61,1,12c1.73,4.39,6,7.5,11,7.5s9.27-3.11,11-7.5C21.27,7.61,17,4.5,12,4.5z M12,17c-2.76,0-5-2.24-5-5s2.24-5,5-5s5,2.24,5,5S14.76,17,12,17z M12,9c-1.66,0-3,1.34-3,3s1.34,3,3,3s3-1.34,3-3S13.66,9,12,9z"/>
                                </svg>
                    ...
                    <div class="mb-6">
                        <label class="flex items-center">
                            <input type="checkbox" name="terms" class="form-checkbox h-5 w-5 text-brown-500 rounded focus:ring-brown-500 border-gray-300" required>
                            <span class="ml-2 text-gray-700">Saya setuju dengan <a href="#" class="text-green-500 hover:underline">Syarat dan Ketentuan</a></span>
                        </label>
                    </div>
                    
                    <button type="submit" class="w-full bg-brown-500 text-white py-2 px-4 rounded-md hover:bg-brown-600 focus:outline-none focus:ring-2 focus:ring-brown-500 focus:ring-opacity-50 transition duration-200 mb-4">Daftar</button>
                    
                    <div class="text-center">
                        <p class="text-gray-600">Sudah punya akun? <a href="{{ route('login') }}" class="text-green-500 hover:underline">Masuk</a></p>
                    </div>
                </form>
            </div>
        </div>
