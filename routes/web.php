...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/biaya-konsumsi/keterangan', [BiayaKonsumsiController::class, 'getKeterangan'])->name('biaya-konsumsi.keterangan');
    Route::get('/biaya-operasional/keterangan', [BiayaOperasionalController::class, 'getKeterangan'])->name('biaya-operasional.keterangan');
...
//Pastikan juga di `routes/web.php` tidak ada route register: ```php
// Pastikan baris ini sudah dihapus atau di-comment:
